...
print("Data writing to 10gb_gpu_hindi_output.csv")
# Create a DataFrame from the data dictionary
df = pd.DataFrame(data)

# Write the DataFrame to a CSV file
df.to_csv("10gb_gpu_hindi_output.csv", index=False, encoding="utf-8")

print("Data written to 10gb_gpu_hindi_output.csv")